...
impl Context {
    ...
    pub fn use_privkey_file(&mut self, file: &str) -> crate::Result<()> {
        todo!()
    }
    ...
    pub fn set_alpn(&mut self, v: &[&[u8]]) -> crate::Result<()> {
        todo!()
    }
...
// mod implementation
impl Handshake {
    pub fn init(&mut self, is_server: bool) -> crate::Result<()> {
        todo!()
    }
    ...
    pub fn set_host_name(&mut self, name: &str) -> crate::Result<()> {
        todo!()
    }
